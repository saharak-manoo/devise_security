module DeviseSecurity
  module Patches
    autoload :ControllerCaptcha, 'devise_security/patches/controller_captcha'
    autoload :ControllerSecurityQuestion, 'devise_security/patches/controller_security_question'

...
module DeviseSecurity
  autoload :Schema, 'devise_security/schema'
  autoload :Patches, 'devise_security/patches'

  module Controllers
    autoload :Helpers, 'devise_security/controllers/helpers'
  end
end

# modules
Devise.add_module :password_expirable, controller: :password_expirable, model: 'devise_security/models/password_expirable', route: :password_expired
Devise.add_module :secure_validatable, model: 'devise_security/models/secure_validatable'
Devise.add_module :password_archivable, model: 'devise_security/models/password_archivable'
Devise.add_module :session_limitable, model: 'devise_security/models/session_limitable'
Devise.add_module :session_non_transferable, model: 'devise_security/models/session_non_transferable'
Devise.add_module :expirable, model: 'devise_security/models/expirable'
Devise.add_module :security_questionable, model: 'devise_security/models/security_questionable'
Devise.add_module :paranoid_verification, controller: :paranoid_verification_code, model: 'devise_security/models/paranoid_verification', route: :verification_code

# requires
require 'devise_security/routes'
require 'devise_security/rails'
require 'devise_security/orm/active_record'
require 'devise_security/models/old_password'
require 'devise_security/models/database_authenticatable_patch'
require 'devise_security/models/paranoid_verification'
